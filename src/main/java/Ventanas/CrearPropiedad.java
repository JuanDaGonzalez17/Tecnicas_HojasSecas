 ...
 * @author Juan David
 */
public class CrearPropiedad extends javax.swing.JFrame {

    /**
     * Creates new form CrearPropiedad
     */
    public CrearPropiedad() {
        super("Crear Propiedad");
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, 100, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 200, 100, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 260, 100, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CrearPropiedad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CrearPropiedad().setVisible(true);
            }
        });
    }
